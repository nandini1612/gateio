...
- **`gateio_final_v2.docx`**, **`gateio_preprint.pdf`** — the earlier **v1 write-up**,
  which reports within-flight-split numbers (~6.72 m). That split leaks (validation and
  test windows sit next to training windows from the same flight), so it overstates
